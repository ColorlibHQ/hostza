...
// image default alt
if( !function_exists( 'hostza_img_default_alt' ) ){
	function hostza_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'hostza_img_tag' ) ){
	function hostza_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = hostza_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'hostza_anchor_tag' ) ){
	function hostza_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'hostza_heading_tag' ) ){
	function hostza_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'hostza_paragraph_tag' ) ){
	function hostza_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'hostza_other_tag' ) ){
	function hostza_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'hostza_button_element ' ) ){
	function hostza_button_element( array $args ){
