 ...
 * @since 1.0
 */
class Hostza_About extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->add_control(
			'left_shade_img',
			[
				'label'         => esc_html__( 'Left Shade Image', 'hostza' ),
        ...
        $this->add_control(
			'center_img',
			[
				'label'         => esc_html__( 'Center Small Image', 'hostza' ),
                'type'          => Controls_Manager::MEDIA,
                'default'       => [
                    'url'       => Utils::get_placeholder_image_src(),
                ]
        ...
        $this->add_control(
			'right_img',
			[
				'label'         => esc_html__( 'Right Image', 'hostza' ),
                'type'          => Controls_Manager::MEDIA,
                'default'       => [
                    'url'       => Utils::get_placeholder_image_src(),
                ]
	...
	protected function render() {
        ...
        $left_shade_img  = !empty( $settings['left_shade_img']['id'] ) ? wp_get_attachment_image( $settings['left_shade_img']['id'], 'hostza_about_section_353x383', false, array( 'class' => 'about_img_1', 'alt' => 'left shade image' ) ) : '';
        $center_img  = !empty( $settings['center_img']['id'] ) ? wp_get_attachment_image( $settings['center_img']['id'], 'hostza_about_section_339x397', false, array( 'class' => 'about_img_2', 'alt' => 'center image' ) ) : '';
        $right_img  = !empty( $settings['right_img']['id'] ) ? wp_get_attachment_image( $settings['right_img']['id'], 'hostza_about_section_529x601', false, array( 'class' => 'about_img_3', 'alt' => 'right image' ) ) : '';
