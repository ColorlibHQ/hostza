 ...
 * @since 1.0
 */
class Hostza_Banner extends Widget_Base {

	public function get_name() {
		return 'hostza-banner';
	}

	public function get_title() {
		return __( 'Banner', 'hostza' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'banner_section',
            [
                'label' => __( 'Banner Section Content', 'hostza' ),
            ]
        );
        $this->add_control(
            'banner_content',
            [
                'label'         => esc_html__( 'Banner Content', 'hostza' ),
                'type'          => Controls_Manager::WYSIWYG,
                'default'       => __( '<h5>Feel like home</h5><h1>Good Look Guaranteed</h1><p>Divide give Dominion wont deep he them seed thing open sixth beast don\'t yea very it meat yielding for air in without one upon it without, his creepeth tree gathering behold and, greater have given deep his</p>', 'hostza' )
            ]
        );
        $this->add_control(
            'banner_btnlabel1',
            [
                'label'         => esc_html__( 'Button Label 1', 'hostza' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'Book Now', 'hostza' )
            ]
        );
        $this->add_control(
            'banner_btnurl1',
            [
                'label'         => esc_html__( 'Button Url 1', 'hostza' ),
        ...
        $this->add_control(
            'banner_btnlabel2',
            [
                'label'         => esc_html__( 'Button Label 2', 'hostza' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'Contact Us', 'hostza' )
            ]
        );
        $this->add_control(
            'banner_btnurl2',
            [
                'label'         => esc_html__( 'Button Url 2', 'hostza' ),
                'type'          => Controls_Manager::URL,
                'show_external' => false
            ]
        );
        ...
        $this->start_controls_section(
            'color_sect', [
                'label' => __( 'Banner Content Styles', 'hostza' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_secttitle', [
                'label'     => __( 'Main Title Color', 'hostza' ),
        ...
        $this->add_control(
            'sec_sep_text',
            [
                'label'     => __( 'Button Styles 1', 'hostza' ),
        ...
        $this->add_control(
            'btn_hvr_txt_color', [
                'label'     => __( 'Button Hover Text Color', 'hostza' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'btn_border_color', [
                'label'     => __( 'Button Hover Border Color', 'hostza' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'sec_sep_text2',
            [
                'label'     => __( 'Button Styles 2', 'hostza' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'btn_border_color2', [
                'label'     => __( 'Button Border Color', 'hostza' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_bg', [
                'label' => __( 'Banner Background', 'hostza' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            'section_bg_after', [
                'label' => __( 'Banner Circle Image', 'hostza' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
