...
/**
 *
 * Hostza elementor few words section widget.
 *
 * @since 1.0
 */
...
class Hostza_Blog extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'blog_content',
            [
                'label' => __( 'Latest Blog Header Setting', 'hostza' ),
            ]
        );
        ...
        $this->add_control(
            'sec_header',
            [
                'label'         => esc_html__( 'Blog Heading Text', 'hostza' ),
                'description'   => esc_html__('Use <br> tag for line break', 'hostza'),
                'type'          => Controls_Manager::WYSIWYG,
                'label_block'   => true,
                'default'       => __( '<h2>Latest Style News</h2><p>Good morning forth gathering doesn\'t god gathering man and had moveth there dry sixth dominion rule divided behold after had he did not move .</p>', 'hostza' )
            ]
        );
        ...
        $this->start_controls_section(
            'blog_post_sec',
            [
                'label' => __( 'Blog Post Settings', 'hostza' ),
            ]
        );
		$this->add_control(
			'post_num',
			[
				'label'         => esc_html__( 'Post Item', 'hostza' ),
		...
		$this->add_control(
			'post_exc',
			[
				'label'         => esc_html__( 'Post Excerpt Length', 'hostza' ),
				'type'          => Controls_Manager::NUMBER,
				'label_block'   => false,
                'default'       => absint(13),
                'min'           => 5,
		...
		$this->add_control(
			'post_order',
			[
				'label'         => esc_html__( 'Post Order', 'hostza' ),
        ...
        $this->start_controls_section(
            'style_section', [
                'label' => __( 'Style Section Heading', 'hostza' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_secttitle', [
                'label'     => __( 'Section Title Color', 'hostza' ),
        ...
        $this->add_control(
            'color_sec_sub_title', [
                'label'     => __( 'Section Sub Title Color', 'hostza' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
        ...
        $this->add_control(
            'item_border_color', [
                'label'     => __( 'Item Border Color', 'hostza' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#e3e6ea',
                'selectors' => [
        ...
        $this->add_control(
            'post_excerpt_color', [
                'label'     => __( 'Post Excerpt Color', 'hostza' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
    ...
    $sec_img    = !empty( $settings['sec_img']['id'] ) ? wp_get_attachment_image( $settings['sec_img']['id'], 'hostza_section_img_29x53', '', array( 'alt' => 'pricing section image' ) ) : '';
