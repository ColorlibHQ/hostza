(function( $ , api){
    ...
    api.section( 'hostza_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'hostza_about_section' , function( section ){
    ...
    api.section( 'hostza_blog_section' , function( section ){
    ...
    api.section( 'hostza_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-hostza_contact_custom_formshortcode'),
                selector = $('#_customize-input-hostza_contact_formshortcode');
    ...
    // General section
    api.section( 'hostza_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#hostza_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-hostza_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-hostza_preloader_color' );
            ...
            var $backtotop          = $( '#hostza_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-hostza_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-hostza_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'hostza_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#hostza_footer_widget_toggle');
