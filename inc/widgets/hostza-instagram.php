...
class hostza_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('hostza_instagram_photo',esc_html__('[ Hostza ] Intagram Photo','hostza'),array(
			'description' => esc_html__('Hostza Instagram Photo Widget','hostza'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'hostza');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'hostza'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'hostza'); ?></label>
